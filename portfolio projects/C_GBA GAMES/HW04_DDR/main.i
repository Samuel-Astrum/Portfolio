...
# 1 "spritesheet.h" 1
# 21 "spritesheet.h"
extern const unsigned char spritesheetTiles[16384];


extern const unsigned char spritesheetPal[512];
# 9 "main.c" 2
# 1 "game.h" 1
...
void goToStart() {
    hideSprites();
    DMANow(3, partyPal, ((volatile unsigned short*) 0x05000000), 256);
...
void goToPause() {
    hideSprites();
    fillScreen4(2);
    drawString4(160 / 2, 240 / 2, "paused...", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    waitForVBlank();
    flipPage();
    state = PAUSE;
}
