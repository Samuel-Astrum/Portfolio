...
# 1 "shot.h" 1
# 21 "shot.h"
extern const unsigned short shotBitmap[200];


extern const unsigned short shotPal[256];
# 5 "game.c" 2
# 1 "party.h" 1
# 21 "party.h"
extern const unsigned short partyBitmap[19200];


extern const unsigned short partyPal[256];
# 6 "game.c" 2
...
void initEnemy() {
    ...
    enemy.enemy.x = 240 - 10 - enemy.enemy.width;
    enemy.enemy.y = 160 / 2 + 20;
    enemy.lives = 3;
    enemy.form = 0;
}
    ...
    for (int i = 0; i < 12; i++) {
        ...
        switch (arrows[i].direction) {
            case LEFT:
                ...
                arrows[i].arrow.x = 240 / 2 - 40;
                arrows[i].arrow.y = 160 - 16;
                break;
            case UP:
                arrows[i].arrow.width = 16;
                arrows[i].arrow.height = 16;
    ...
    if (activeCount < 3 && frameCount > 90) {
        ...
        if (!arrows[index].active) {
            ...
            switch (arrows[index].direction) {
                case LEFT:
                    arrows[index].arrow.x = 240 / 2 - 40;
                    arrows[index].arrow.y = 160 - 16;
                    break;
                case UP:
                    arrows[index].arrow.x = 240 / 2 - 20;
                    arrows[index].arrow.y = 160 - 16;
                    break;
                case RIGHT:
                    arrows[index].arrow.x = 240 / 2;
                    arrows[index].arrow.y = 160 - 16;
                    break;
                case DOWN:
                    arrows[index].arrow.x = 240 / 2 + 20;
         ...
         switch (arrows[i].direction) {
             case LEFT:
                 if (collision(arrows[i].arrow.x, arrows[i].arrow.y, arrows[i].arrow.width, arrows[i].arrow.height, holes[0].x, holes[0].y, holes[0].width-5, 2)) {
                    ...
                    *(volatile u16*)0x0400006C = NOTE_A4 | (1<<15);
                    }
...
void drawPlayer() {
    shadowOAM[player.player.oamIndex].attr0 = ((player.player.y) & 0xFF) | (2<<14);
    shadowOAM[player.player.oamIndex].attr1 = ((player.player.x) & 0x1FF) | (3<<14);
    shadowOAM[player.player.oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (8))) & 0x3FF));
}

void drawEnemy() {
    shadowOAM[enemy.enemy.oamIndex].attr0 = ((enemy.enemy.y) & 0xFF) | (0<<14);
    shadowOAM[enemy.enemy.oamIndex].attr1 = ((enemy.enemy.x) & 0x1FF) | (3<<14);
    shadowOAM[enemy.enemy.oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (12))) & 0x3FF));
}

void drawArrowBlocks() {
    shadowOAM[holes[0].oamIndex].attr0 = ((holes[0].y) & 0xFF) | (0<<14) | (0<<8);
    shadowOAM[holes[0].oamIndex].attr1 = (1<<14) | ((holes[0].x) & 0x1FF);
    shadowOAM[holes[0].oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (6))) & 0x3FF));

    shadowOAM[holes[1].oamIndex].attr0 = ((holes[1].y) & 0xFF) | (0<<14) | (0<<8);
    shadowOAM[holes[1].oamIndex].attr1 = (1<<14) | ((holes[1].x) & 0x1FF);
    shadowOAM[holes[1].oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (2))) & 0x3FF));

    shadowOAM[holes[2].oamIndex].attr0 = ((holes[2].y) & 0xFF) | (0<<14) | (0<<8);
    shadowOAM[holes[2].oamIndex].attr1 = (1<<14) | ((holes[2].x) & 0x1FF);
    shadowOAM[holes[2].oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (0))) & 0x3FF));

    shadowOAM[holes[3].oamIndex].attr0 = ((holes[3].y) & 0xFF) | (0<<14) | (0<<8);
    shadowOAM[holes[3].oamIndex].attr1 = (1<<14) | ((holes[3].x) & 0x1FF);
    shadowOAM[holes[3].oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (4))) & 0x3FF));
}

void drawShot() {
    if (shot.active) {
        shadowOAM[shot.shot.oamIndex].attr0 = ((shot.shot.y) & 0xFF) | (0<<14);
        shadowOAM[shot.shot.oamIndex].attr1 = ((shot.shot.x) & 0x1FF) | (1<<14);
        shadowOAM[shot.shot.oamIndex].attr2 = (((0) & 0xF) <<12) | (((1) & 3) << 10) | (512 + ((((0) * (32) + (20))) & 0x3FF));
    } else if (shot.shot.hide) {
        shadowOAM[shot.shot.oamIndex].attr0 = (2<<8);
    }
}
...
void drawArrows() {
    for (int i = 0; i < 12; i++) {
        if (arrows[i].active) {
            shadowOAM[arrows[i].arrow.oamIndex].attr0 = ((arrows[i].arrow.y) & 0xFF) | (0<<14);

            shadowOAM[arrows[i].arrow.oamIndex].attr1 = ((arrows[i].arrow.x) & 0x1FF) | (1<<14);
            switch (arrows[i].direction) {
            case LEFT:
            shadowOAM[arrows[i].arrow.oamIndex].attr2 = (((0) & 0xF) <<12) | (((0) & 3) << 10) | (512 + ((((2) * (32) + (6))) & 0x3FF));
            break;
            case UP:
            shadowOAM[arrows[i].arrow.oamIndex].attr2 = (((0) & 0xF) <<12) | (((0) & 3) << 10) | (512 + ((((2) * (32) + (2))) & 0x3FF));
            break;
            case RIGHT:
            shadowOAM[arrows[i].arrow.oamIndex].attr2 = (((0) & 0xF) <<12) | (((0) & 3) << 10) | (512 + ((((2) * (32) + (0))) & 0x3FF));
            break;
            case DOWN:
            shadowOAM[arrows[i].arrow.oamIndex].attr2 = (((0) & 0xF) <<12) | (((0) & 3) << 10) | (512 + ((((2) * (32) + (4))) & 0x3FF));
            break;
            }
        } else if (arrows[i].arrow.hide) {
            shadowOAM[arrows[i].arrow.oamIndex].attr0 = (2<<8);
        }
    }
}
