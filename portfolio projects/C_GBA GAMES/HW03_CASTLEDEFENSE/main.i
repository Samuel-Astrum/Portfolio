...
void initialize() {
    ...
    *(volatile u16*)0x04000080 = (((5) & 7) << 0) | (((5) & 7) << 4) | (1 << 8) | (1 << 12) | (1 << 9) | (1 << 13) | (1 << 10) | (1 << 14) | (1 << 11) | (1 << 15);
...
void goToStart() {
    ...
    state = START;
    rSeed = 0;
    drawString(70, 60, "CASTLE DEFENSE!!!!!", (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    drawString(60, 100, "PRESS START TO PLAY :D", (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
}
...
void game() {
    ...
    waitForVBlank();
    drawRectangle(160, 110, 60, 30, (((15) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    drawString(160, 110, buffer, (((0) & 31) | ((10) & 31) << 5 | ((0) & 31) << 10));
    drawRectangle(160, 140, 60, 30, (((15) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    if (wallHealth > 0) {
        drawString(160, 140, lifeBuffer, (((0) & 31) | ((10) & 31) << 5 | ((0) & 31) << 10));
    }
...
void goToPause() {
    fillScreen((((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    waitForVBlank();
    state = PAUSE;
    drawString(70, 60, "PAUSED...", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
    drawString(60, 100, "PRESS START TO RESUME", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
...
void goToWin() {
    ...
    waitForVBlank();
    state = WIN;
    drawString(50, 60, "YOU PROTECTED THE CROWN!", (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    drawString(80, 100, "YOU WIN!!!!!", (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    drawString(20, 140, "PRESS START TO RETURN TO MAIN MENU", (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
...
void goToLose() {
    ...
    waitForVBlank();
    state = LOSE;
    drawString(50, 60, "YOU LET THEM TAKE THE CROWN...", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
    drawString(80, 100, "YOU LOSE.. :(", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
    drawString(20, 140, "PRESS START TO RETURN TO MAIN MENU", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
